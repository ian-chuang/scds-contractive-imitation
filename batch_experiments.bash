...
# $python train.py --model-type discrete --device cuda:0  --dim-x 32 --total-epochs 30000 --expert lasa --motion-shape Multi_Models_1 --experiment-dir boards/multi-models --crate-lb 1.0 --batch-size 70 --num-expert-trajectories 7&
# $python train.py --model-type discrete --device cuda:0  --dim-x 32 --total-epochs 30000 --expert lasa --motion-shape Multi_Models_2 --experiment-dir boards/multi-models --crate-lb 1.0 --batch-size 70 --num-expert-trajectories 7&
# $python train.py --model-type discrete --device cuda:0  --dim-x 32 --total-epochs 30000 --expert lasa --motion-shape Multi_Models_3 --experiment-dir boards/multi-models --crate-lb 1.0 --batch-size 70 --num-expert-trajectories 7&
# $python train.py --model-type discrete --device cuda:0  --dim-x 32 --total-epochs 30000 --expert lasa --motion-shape Multi_Models_4 --experiment-dir boards/multi-models --crate-lb 1.0 --batch-size 70 --num-expert-trajectories 7&
