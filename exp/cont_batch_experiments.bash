...
mm_motions=("Multi_Models_1" "Multi_Models_2" "Multi_Models_4")
...
for shape in "${mm_motions[@]}"; do
    echo %%% Running experiments for $shape motion %%%
    $python train.py --model-type continuous  --device cuda:0  --dim-x 64  --total-epochs 1000 --motion-shape $shape --experiment-dir boards/cont/new/multi_models --bijection --num-bijection-layers 8 --crate-lb 12.6  --num-expert-trajectories 7&
